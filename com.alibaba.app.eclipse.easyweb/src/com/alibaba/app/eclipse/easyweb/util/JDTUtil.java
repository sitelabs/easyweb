...
/**
 * Utility class for JDT It might exist better way to implements those operations, or they might already exist in JDT
 */
...
public class JDTUtil {
    ...
    public static void removeNatureToProject(IProject project, String natureId) throws CoreException {
        ...
        if (natureIndex != -1) {
            ...
            System.arraycopy(prevNatures, natureIndex + 1, newNatures, natureIndex, prevNatures.length
                                                                                    - (natureIndex + 1));
            description.setNatureIds(newNatures);
            proj.setDescription(description, null);
        }
