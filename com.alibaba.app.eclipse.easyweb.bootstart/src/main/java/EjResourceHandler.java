...
/* ------------------------------------------------------------ */
/**
 * Resource Handler. This handle will serve static content and handle If-Modified-Since headers. No caching is done.
 * Requests that cannot be handled are let pass (Eg no 404's)
 * 
 * @org.apache.xbean.XBean
 */
public class EjResourceHandler extends AbstractHandler {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set if resource aliases (eg symlink, 8.3 names, case insensitivity) are allowed. Allowing aliases can
     * significantly increase security vulnerabilities. If this handler is deployed inside a ContextHandler, then the
    ...
    public void doStart() throws Exception {
        ...
        if (_context != null) _aliases = _context.isAliases();

        if (!_aliases && !FileResource.getCheckAliases()) throw new IllegalStateException("Alias checking disabled");
    ...
    protected Resource getResource(HttpServletRequest request) throws MalformedURLException {
        ...
        if (path_info == null || path_info.equals("/")) return null;
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty.server.server.Handler#handle(javax.servlet.http.HttpServletRequest,
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the response headers. This method is called to set the response headers such as content type and content
     * length. May be extended to add additional headers.
     * 
     * @param response
     * @param resource
     * @param mimeType
